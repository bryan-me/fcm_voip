                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return GestureDetector(
                                  ...
                                  // onTap: () {
                                  //   // Get the form data from FormController
                                  //   final tappedFormId = form.id;
                                  //   final formData = Get.find<FormController>().formData;
                                  //   final payload = formData['payload'] ?? [];
                                  //   final formController = Get.find<FormController>();
                                  //   final isFormSubmitted = formController.isFormSubmitted.value;
                                  //
                                  //
                                  //   if(isFormSubmitted) {
                                  //     showDialog(
                                  ...
                                  //       builder: (context) {
                                  //         return Dialog(
                                  //           insetPadding: const EdgeInsets.symmetric(horizontal: 20), // Add some padding around the dialog
                                  //           backgroundColor: Colors.transparent, // Ensure no default background is set
                                  //           child: ClipPath(
                                  //             clipper: ZigZagClipper(),
                                  //             child: Container(
                                  //               width: MediaQuery.of(context).size.width * 0.9, // Set the width to 90% of the screen
                                  //               height: MediaQuery.of(context).size.height * 0.7, // Increase height to 70% of the screen
                                  ...
                                  //                   _buildIdRow('', formData['formId']?.toString() ?? 'N/A'),
                                  //
                                  //                   SizedBox(height: 20,),
                                  //
                                  //                   const DashedDivider(
                                  ...
                                  //                         crossAxisSpacing: 10,
                                  //                         mainAxisSpacing: 10,
                                  //                         childAspectRatio: 3, // Adjust for better text fit
                                  //                       ),
                                  //                       itemCount: payload.length,
                                  //                       itemBuilder: (context, index) {
                                  //                         final entry = payload[index];
                                  ...
                                  //     print("Form has not been submitted. Navigating to form.");
                                  //     Navigator.push(
                                  //       context,
                                  //       MaterialPageRoute(
                                  //         builder: (context) =>
